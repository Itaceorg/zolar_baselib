...
public class ZBroadcast {
    ...
    private static class CustomBroadcastReceiver extends BroadcastReceiver {
        private OnReceiveBroadcast mOnReceiveBroadcast;

        public CustomBroadcastReceiver(OnReceiveBroadcast onReceiveBroadcast) {
            this.mOnReceiveBroadcast = onReceiveBroadcast;
        }

        @Override
        public void onReceive(Context context, Intent intent) {
            if (mOnReceiveBroadcast != null) {
                try {
                    mOnReceiveBroadcast.onReceive(context, intent);
    ...
    public static void send(Context context, String filter) {
        if (context == null) {
            return;
        }
    ...
    public static void send(Context context, String filter, Bundle bundle) {
        if (context == null) {
            return;
        }
        Intent intent = new Intent();
    ...
    public static void send(Context context, String filter, String name, Serializable serializable) {
        Intent intent = new Intent();
    ...
    public static void send(Context context, String filter, String name, String value) {
        Intent intent = new Intent();
    ...
    public static void send(Context context, String filter, String name, long value) {
        Intent intent = new Intent();
        intent.putExtra(name, value);
        intent.setAction(filter);
        context.sendBroadcast(intent);
    ...
    public static void send(Context context, String filter, String name, int value) {
        Intent intent = new Intent();
        intent.putExtra(name, value);
        intent.setAction(filter);
        context.sendBroadcast(intent);
    ...
    public static void send(Context context, String filter, String name, String value, String name1, String value1) {
        Intent intent = new Intent();
        intent.putExtra(name, value);
